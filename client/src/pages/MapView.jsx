  ...
  function buildInfoHtml(v) {
    ...
    return `<div style="font-family:Arial,sans-serif;font-size:13px;line-height:1.4;width:240px;box-sizing:border-box;overflow:hidden;">
      ...
      <div style="display:flex;gap:6px;justify-content:center;">
        ...
        <button onclick="window._fleetproSaveLocation(${v.lat},${v.lon},'${v.address||''}')" style="background:#7c3aed;color:#fff;border:none;border-radius:6px;padding:5px 10px;font-size:11px;font-weight:600;cursor:pointer;flex:1;">📍 Save Point</button>
      </div>
      ${taskSection}
    </div>`;
  }
